<?php
/**
 *	TestUnit of CeusMedia\Math\Algebra\LabelMatrix.
 ...
 *	@package		Tests.math.algebra
 *	@extends		Test_Case
 *	@uses			CeusMedia\Math\Algebra\LabelMatrix
 *	@author			Christian Würker <christian.wuerker@ceusmedia.de>
 *	@since			17.06.2008
 *	@version		0.1
 */
class Test_Math_Algebra_LabelMatrixTest extends Test_Case
{
	...
	public function setUp()
	{
		...
		$this->matrix	= new CeusMedia\Math\Algebra\LabelMatrix( $rows, $columns );
	...
	public function testConstruct()
	{
		$rows		= array( "A1" );
		$columns	= array( "B1", "B2", "B3" );
		$matrix		= new CeusMedia\Math\Algebra\LabelMatrix( $rows, $columns, 10 );
	...
	public function testConstructException1()
	{
		...
		new CeusMedia\Math\Algebra\LabelMatrix( array(), array( "a", "b", "c", "d", "e" ) );
	}
	...
	{
		$this->setExpectedException( 'InvalidArgumentException' );
		new CeusMedia\Math\Algebra\LabelMatrix( array( "a", "b", "c", "d", "e" ), array() );
	}
