...
use CeusMedia\Math\Formula as Formula;
use CeusMedia\Math\CompactInterval as CompactInterval;
/**
 *	Calculates Integral with Sampling Nodes within a compact Interval.
 *	@category		Library
 *	@package		CeusMedia_Math_Analysis
...
class Integration{
	...
	/**	@var		Formula			$formula		Formula to integrate */
	protected $formula;
	/**	@var		CompactInterval	$interval		Interval to integrate within */
	protected $interval;
	 ...
	 *	@param		CompactInterval	$interval		Interval to integrate within
